...
namespace EcommerceAPI.WebAPI.Migrations
{
    ...
    [Migration("20231226135117_AddSeedDataProduct")]
            ...
            modelBuilder.Entity("EcommerceAPI.Core.src.Entity.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7152),
                            Image = "https://picsum.photos/1000/1000?random=1",
                            Name = "Fashion",
                            UpdatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7154)
                        },
                        new
                        {
                            Id = new Guid("23b984f8-26f7-49a5-82ea-f4f5ddd16eca"),
                            CreatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7159),
                            Image = "https://picsum.photos/1000/1000?random=2",
                            Name = "Sport",
                            UpdatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7161)
                        },
                        new
                        {
                            Id = new Guid("e842529a-ac4a-48f4-9377-1786d94dd4e8"),
                            CreatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7163),
                            Image = "https://picsum.photos/1000/1000?random=3",
                            Name = "Home",
                            UpdatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7165)
                        });
                });
            ...
            modelBuilder.Entity("EcommerceAPI.Core.src.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7030),
                            Email = "admin@mail.com",
                            FirstName = "Admin",
                            LastName = "admin",
                            Password = "admin",
                            Role = Role.Admin,
                            UpdatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7079)
                        },
                        new
                        {
                            Id = new Guid("760454fa-4af1-4ae6-9b18-ed3aec4be2a9"),
                            Avatar = "https://picsum.photos/1000/1000?random=1",
                            CreatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7089),
                            Email = "cena@mail.com",
                            FirstName = "John",
                            LastName = "Cena",
                            Password = "password",
                            Role = Role.Customer,
                            UpdatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7091)
                        },
                        new
                        {
                            Id = new Guid("611a0192-8b2e-4997-a8c8-59b93674d33b"),
                            Avatar = "https://picsum.photos/1000/1000?random=1",
                            CreatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7094),
                            Email = "doe@mail.com",
                            FirstName = "John",
                            LastName = "Doe",
                            Password = "password",
                            Role = Role.Customer,
                            UpdatedAt = new DateTime(2023, 12, 26, 15, 51, 17, 620, DateTimeKind.Local).AddTicks(7096)
                        });
                });
